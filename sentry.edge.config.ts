...
Sentry.init({
  dsn: process.env.SENTRY_DSN || process.env.NEXT_PUBLIC_SENTRY_DSN || "https://placeholder-dsn@o0.ingest.sentry.io/0",
  
  // Performance Monitoring
  tracesSampleRate: 0.1, // 10% sample rate for edge runtime
